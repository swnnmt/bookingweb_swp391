...
public static String getToken(String code) throws ClientProtocolException, IOException {
    ...
    throws ServletException, IOException {
		...
		UserGoogleDto user = getUserInfo(accessToken);
                ...
                Account newAccount= new Account(user.getName(), user.getEmail(), user.getId(), 2);
                session.setAttribute("user", newAccount);
                DAO check_account= new DAO();
                boolean check_exist = check_account.getAccountByUsername(user.getId());
                if(check_exist){
                check_account.insertAccount(newAccount);
                }
